build/./src/handlers/handlers-init.cpp.o: src/handlers/handlers-init.cpp \
  src/handlers/handlers-init.hpp src/auth/authenticator.hpp \
  src/auth/accounts-registry.hpp src/models/account.hpp \
  ...
  src/storage/storage.hpp /usr/local/include/pqxx/pqxx \
  ...
  /usr/local/include/pqxx/internal/transaction_focus.hxx \
  ...
  /usr/local/include/pqxx/transactor.hxx src/handlers/dispatcher.hpp \
  src/handlers/base-handler.hpp \
  /usr/local/include/boost/beast/version.hpp src/handlers/util.hpp \
  src/auth/exceptions.hpp src/models/games-registry.hpp \
  src/models/game.hpp src/models/game-update.hpp src/models/card.hpp \
  src/server/websocket-session.hpp /usr/local/include/boost/asio.hpp \
  ...
  /usr/local/include/boost/beast/zlib.hpp src/server/util.hpp \
  src/handlers/accounts-handler.hpp src/handlers/games-handler.hpp \
  src/handlers/login-handler.hpp src/handlers/logout-handler.hpp

src/handlers/handlers-init.hpp:

src/auth/authenticator.hpp:

src/auth/accounts-registry.hpp:
...
src/handlers/dispatcher.hpp:

src/handlers/base-handler.hpp:

/usr/local/include/boost/beast/version.hpp:

src/handlers/util.hpp:

src/auth/exceptions.hpp:

src/models/games-registry.hpp:

src/models/game.hpp:

src/models/game-update.hpp:

src/models/card.hpp:

src/server/websocket-session.hpp:
...
src/handlers/accounts-handler.hpp:

src/handlers/games-handler.hpp:

src/handlers/login-handler.hpp:

src/handlers/logout-handler.hpp:
